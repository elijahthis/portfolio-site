...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      link: "mailto:emperorelijah007@gmail.com?subject=I'd Love to Work with You!",
    },
  ];
          ...
          <div>
            <label>
              ...
              <textarea
                style={{ height: "100px" }}
                name="message"
                placeholder="Hello. I believe a collaboration on my next project would be in order."
                required
              ></textarea>
            </label>
          </div>
